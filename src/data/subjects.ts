...
import { AP_PHYSICS_UNITS } from "./ap-physics/units";
import physicsDiscoveries from "./ap-physics/discoveries.json";
...
export const AP_PHYSICS: SubjectData = {
  id: "ap-physics",
  name: "AP Physics",
  shortName: "AP Physics",
  discipline: "Physics",
  units: AP_PHYSICS_UNITS,
  discoveries: physicsDiscoveries as Discovery[],
};
...
export const SUBJECT_LISTINGS: SubjectListing[] = [
  ...
  { id: "ap-physics", name: "AP Physics", emoji: "🍎", available: true },
